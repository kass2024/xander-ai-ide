...
const TOOL_TITLES: Record<string, string> = {
  ...
  inspect_database: 'Analyze database config',
  inspect_xampp_mysql: 'Connect to XAMPP MySQL',
  mysql_list_databases: 'Browse MySQL databases',
  mysql_describe_table: 'Inspect table schema',
  mysql_query: 'Run SQL query',
  mysql_execute: 'Execute SQL statement',
